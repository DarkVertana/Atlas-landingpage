...
const staticRoutes: {
  ...
  { path: "/services/county-court-searches", priority: 0.8, changeFrequency: "monthly" },
  ...
  { path: "/services/international-check", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/staffing-agencies", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/healthcare", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/transportation-logistics", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/financial-services", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/retail-hospitality", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/education", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/nonprofit-volunteer", priority: 0.7, changeFrequency: "monthly" },
  ...
  { path: "/industries/startups", priority: 0.7, changeFrequency: "monthly" },
  { path: "/industries/enterprise", priority: 0.7, changeFrequency: "monthly" },
