...
export const metadata: Metadata = {
  ...
  description:
    "Atlas Tenant: FCRA-compliant tenant screening for landlords and property managers. Criminal, credit & ResidentScore, eviction, identity, and income — one applicant-guided report. Pay as you go from $24.99.",
