...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: "Core check",
    group: "Identity & criminal",
    tagline: "Records pulled directly from the court of record, county by county.",
    intro:
      "A county court search goes straight to the source: the local courthouse where a case was actually filed. It is the most authoritative layer of a criminal check, catching records a national database pointer can miss or report without disposition. Atlas searches every relevant county surfaced by the identity trace and applies FCRA lookback rules automatically.",
    features: [
      "Direct court-of-record searches",
      "Felony and misdemeanor coverage",
      "Verified, up-to-date dispositions",
      "7-year FCRA lookback applied",
      "Counties selected from the identity trace",
      "Researcher-confirmed potential matches",
    ],
    included: [
      { title: "Court of record", desc: "Pulled from the county courthouse, not an aggregator.", icon: iconBuilding },
      { title: "Disposition detail", desc: "Charges surfaced with current, verified outcomes.", icon: iconDoc },
      { title: "Compliant filtering", desc: "FCRA and state lookback rules applied automatically.", icon: iconShield },
    ],
    useCases: [
      "General employment screening",
      "Roles requiring authoritative records",
      "Filling gaps left by database-only searches",
    ],
    turnaround: "1 – 3 business days (varies by county)",
    priceFrom: "Included in Standard & Premium",
    priceNote: true,
    detailHref: "/services/county-court-searches",
    image: "/assets/services/criminal-background-checks.webp",
    start: { service: "criminal-background-checks" },
  },
  {
  ...
  {
    slug: "international-check",
    name: "International Background Checks",
  ...
  },
  {
    ...
    features: [
      ...
      "International Check (domestic + intl)",
