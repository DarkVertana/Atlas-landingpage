...
export const services: Service[] = [
  {
    ...
    features: [
      "National criminal database pointer search",
    ...
    included: [
      ...
      { title: "Adjudication matrix", desc: "Rules engine flags hits for human review with a full audit trail.", icon: iconShield },
      { title: "Database vs. report", desc: "Database pointers return fast; verified county results follow, most the same day.", icon: iconClock },
    ],
    useCases: [
  ...
  },
  {
    ...
    intro:
      "Validate the subject's Social Security Number, surface aliases and prior names, and assemble a residential history. The SSN trace is how we decide which counties to search — skipping it makes every downstream check less accurate.",
    features: [
    ...
    included: [
      ...
      { title: "Fast database results", desc: "Database pointers typically return in under a minute; the full report follows.", icon: iconClock },
    ],
    useCases: [
  ...
  },
  {
    ...
    included: [
      { title: "Nationwide sweep", desc: "State registries, the federal database, and territories searched together.", icon: iconShield },
      { title: "Verified matches", desc: "Potential hits are reviewed by an analyst before you see them.", icon: iconUser },
      { title: "Fast database results", desc: "Registry searches typically return in minutes.", icon: iconClock },
    ],
    useCases: [
  ...
  },
  {
    ...
    included: [
      { title: "Global coverage", desc: "Domestic and international watchlists searched together.", icon: iconGlobe },
      { title: "Verified matches", desc: "Potential hits are reviewed before they reach your report.", icon: iconShield },
      { title: "Fast database results", desc: "Watchlist searches typically return in minutes.", icon: iconClock },
    ],
    useCases: [
  ...
  },
  {
    ...
    features: [
      ...
      "At-fault accident history where reported",
      "CDL endorsements and restrictions",
      "State-by-state DMV sourcing",
      "Optional continuous driver monitoring",
    ],
    included: [
      { title: "DMV-sourced", desc: "Records pulled from state DMVs, not aggregated databases.", icon: iconCar },
      { title: "CDL support", desc: "Commercial endorsements and restrictions surfaced for fleet roles.", icon: iconDoc },
  ...
  },
  {
    ...
    included: [
      ...
      { title: "Dispute-ready", desc: "Applicants can initiate a dispute directly from their completed report.", icon: iconShield },
    ],
    useCases: [
  ...
  },
  {
    ...
    intro:
      "Employment-purpose credit reports for financial, fiduciary, and executive hires. A soft inquiry — no impact to the applicant's score — with permissible-purpose verification and state-law gating applied automatically.",
    features: [
    ...
    included: [
      ...
      { title: "State-law gating", desc: "Non-compliant pulls are blocked automatically by location.", icon: iconShield },
      { title: "Scoped to the role", desc: "Used only where financial responsibility is a documented requirement.", icon: iconDoc },
    ],
    useCases: [
  ...
  },
  {
    ...
    features: [
      "Arrest & booking records across data sources",
      "County-level court record monitoring",
      "National criminal database pointer searches",
      "Global watchlist search (domestic + international)",
      "Sex offender registry search nationwide",
      "Verifier-reviewed alerts with a full audit trail",
    ],
    included: [
      { title: "Verified alerts", desc: "Every change is verified and analyst-reviewed before an alert is raised.", icon: iconShield },
      { title: "Consent built in", desc: "Monitoring begins only after consent and permissible purpose are documented.", icon: iconUser },
      { title: "Adverse-action support", desc: "Two-step adverse-action workflow ready if you act on an alert.", icon: iconClock },
    ],
    useCases: [
      "Existing workforce",
      "High-turnover roles",
