  ...
  return (
    <ServiceDetail
      ...
      features={[
        ...
        { title: "International Check", desc: "Recurring check against domestic and international watchlist sources.", icon: <I d="M12 2a10 10 0 100 20 10 10 0 000-20zM12 2c3 3 3 17 0 20M12 2c-3 3-3 17 0 20M3.5 8.5c2.5 2 12.5 2 17 0M3.5 15.5c2.5-2 12.5-2 17 0" /> },
