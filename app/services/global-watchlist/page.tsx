  ...
  return (
    <ServiceDetail
      ...
      features={[
        ...
        { title: "Adverse media", desc: "Global negative-news screening across regulated press for fraud, corruption, and financial crime.", icon: <I d="M4 5.25A1.25 1.25 0 015.25 4h9.5A1.25 1.25 0 0116 5.25v13.5A1.25 1.25 0 0017.25 20H6a2 2 0 01-2-2V5.25zM16 8h2.75A1.25 1.25 0 0120 9.25V18a2 2 0 01-2 2M7.5 8.5l3 3 5-5" /> },
        { title: "Continuous monitoring", desc: "Enrolled candidates are re-screened daily, so new sanctions or PEP status triggers instant alerts.", icon: <I d="M12 8v4l3 2M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> },
      ]}
      steps={[
