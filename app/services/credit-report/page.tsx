  ...
  return (
    <ServiceDetail
      ...
      features={[
        ...
        { title: "Payment history", desc: "Delinquencies, collections, charge-offs, and public records relevant to financial trust.", icon: <I d="M12 3a9 9 0 100 18 9 9 0 000-18zM12 7v5l3 2" /> },
        { title: "Bankruptcy & liens", desc: "Active bankruptcies, tax liens, and civil judgments from credit and public-record sources.", icon: <I d="M12 3l8 5H4l8-5zM6 8v9M12 8v9M18 8v9M4 21h16" /> },
        { title: "State-law gating", desc: "11 states restrict credit-based employment decisions, so Atlas blocks non-compliant pulls automatically.", icon: <I d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75" /> },
